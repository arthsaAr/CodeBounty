...
const Repository = ({
  ...
  return (
    <div 
        onClick={onSelect}
        className='rounded-xl bg-[#151920] border border-gray-800 p-6 mt-2 hover:border-emerald-500 hover:bg-emerald-500/5'>
        ...
        <div className='flex flex-row gap-2 mt-2'>
            ...
            <div className='flex flex-row gap-1 items-center'>
                ...
                <h1 className='text-gray-400 text-md'>{language}</h1>
            </div>

            <div className='flex flex-row gap-1 items-center'>
                <FaStar color="yellow" className="text-yellow-400 drop-shadow-md" size={20}/>
                <h1 className='text-gray-400 text-md'>{stars}</h1>
            </div>
        </div>
    </div>
  )
